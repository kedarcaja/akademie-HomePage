      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-14 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-brand-text-muted text-sm leading-relaxed max-w-xs mb-5">
              Kreativně-vzdělávací projekt od{' '}
              <span className="text-brand-parchment-dim">Valiente Projectu</span>.
              Spojujeme fantasy, řemeslo a vzdělání.
            </p>
          ...
          {/* Akademie links */}
          <div>
            <h3 className="font-cinzel text-brand-parchment-dim font-semibold text-xs tracking-[0.15em] uppercase mb-4">
              Akademie
            </h3>
            <ul className="space-y-2.5">
              {footerLinks.akademie.map(({ href, label }) => (
                <li key={label}>
                  <a
                    href={href}
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {footerLinks.podpora.map(({ href, label }) => (
                <li key={label}>
                  <a
                    href={href}
                    className="text-brand-text-muted hover:text-brand-gold text-sm transition-colors duration-200"
        ...
        <div className="py-5 border-t border-brand-border flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-brand-text-dim text-xs">
            © 2024 Valiente Project. Všechna práva vyhrazena.
          </p>
          <div className="flex items-center gap-4">
            <a href="#" className="text-brand-text-dim hover:text-brand-text-muted text-xs transition-colors">
