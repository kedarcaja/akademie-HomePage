    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute right-0 top-0 bottom-0 w-full md:w-3/5 lg:w-1/2">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-l from-transparent via-brand-darker/40 to-brand-darker" />
        </div>
      </div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-32 md:py-40">
        <div className="max-w-xl lg:max-w-2xl">
          ...
          {/* Main heading */}
          <h1 className="font-cinzel font-bold text-brand-parchment leading-tight mb-2">
            <span className="block text-3xl sm:text-4xl lg:text-5xl">VSTUP DO</span>
            <span className="block text-4xl sm:text-5xl lg:text-6xl text-brand-gold">DRAČÍ AKADEMIE</span>
          </h1>

          {/* Tagline */}
          <p className="text-brand-text-muted text-sm tracking-[0.18em] uppercase font-medium mb-5 mt-3">
            Fantazie. Řemeslo. Soustředění.
          </p>

          {/* Description */}
          <p className="text-brand-text text-base md:text-lg leading-relaxed mb-10 max-w-lg font-light">
            Kreativní svět, kde se děti i dospělí učí{' '}
            <span className="text-brand-parchment font-normal">tvořit rukama</span>, malovat figurky, pracovat
            s chybou a růst — krok za krokem.
          </p>

          {/* CTA buttons */}
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#zacni-tady" className="btn-primary">
              <span>🐉</span>
              Začni tady
            </a>
          ...
          {/* Microcopy */}
          <p className="mt-8 text-brand-text-dim text-xs italic">
            Žádné soutěže ega, jen radost z tvorby. Chybám se u nás tleská. 🔥
          </p>
        </div>
      </div>
